...
public class StaticCatalogStore
{
    ...
    @Inject
    public StaticCatalogStore(Announcer announcer, ConnectorManager connectorManager, StaticCatalogStoreConfig config)
    {
        this(announcer, connectorManager,
                config.getCatalogConfigurationDir(),
                firstNonNull(config.getDisabledCatalogs(), ImmutableList.of()), config.isAutoDetectCatalog());
    }

    public StaticCatalogStore(Announcer announcer, ConnectorManager connectorManager, File catalogConfigurationDir, List<String> disabledCatalogs, boolean autoDetectCatalog)
    {
